// <copyright file="CountPaths.cs" company="Umbriel Project">
...
namespace Umbriel.ArcMap.NetworkAnalysis.UI
{
    ...
    /// </summary>
    [Guid("6b27cb49-7898-48d6-945f-dccd8c96b620")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("Umbriel.ArcMap.NetworkAnalysis.UI.CountPaths")]
    public sealed class CountPaths : BaseCommand
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountPaths"/> class.
        /// </summary>
        public CountPaths()
        {
            base.m_category = "Umbriel";
            base.m_caption = "Count paths from junction flag to selected feature locations.";
            base.m_message = "Count paths from junction flag to selected feature locations.";
            base.m_toolTip = "Count paths from junction flag to selected feature locations.";
            base.m_name = "Umbriel_CountPaths";

            try
            {
                base.m_bitmap = Umbriel.ArcMap.NetworkAnalysis.Properties.Resources.CountPathsIcon;
            }
            catch (Exception ex)
            {
