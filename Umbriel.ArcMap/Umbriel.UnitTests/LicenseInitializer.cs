...
//   JCummins       2009-07-08    modification of ESRI LicenseInitializer class
//                                                      -added 1-additional constructor (single product code-no extensions)
// </summary>
...
namespace GeoprocessingInDotNet
{
    internal sealed class LicenseInitializer
    {
        ...
        public bool InitializeApplication(esriLicenseProductCode productCode)
        {
            esriLicenseProductCode[] codes = new esriLicenseProductCode[1];
            codes[0] = productCode;

            return InitializeApplication(codes, null);
        }
